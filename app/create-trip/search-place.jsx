...
export default function searchPlace() {
  ...
  return (
    <View style={{height:'100%' , marginTop:25 , padding:25  }}>
         {/*title maker  */}
    <CreateTitle title='Search'/>   


     <TextInput onChangeText={(v)=> setPlace(v)} placeholder='Search place' style={{width:'100%' , borderRadius:7 , borderWidth:1 , borderColor:'black', marginBottom:20 , height:40}}/>
